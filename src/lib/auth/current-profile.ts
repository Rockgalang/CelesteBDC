...
/** Page-level guard: redirect non-matching roles to the app root instead of
 * rendering. Use in addition to RLS, never instead of it — this only hides
 * UI, the database policies are the real authorization boundary. */
